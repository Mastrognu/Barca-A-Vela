...
import it.mangusto.barca.serverInterface.IServerInterface;
import it.mangusto.barca.serverInterface.ServiceCommunicator;
...
public class Main extends SherlockActivity {
	...
	public static final String CLASS_IDENTIFIER = Main.class.toString();

	/*
	 * Usare questo per qualunque comunicazione con il server.
	 * DO NOT EVER CAST IT! Lo faccio solo io per gestire la classe che lo implementa, a te (MANGUSTO) non deve servire!
	 */
	private IServerInterface mCommunicator;
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		if(requestCode == ServiceCommunicator.REQUEST_ENABLE_BT)
			((ServiceCommunicator) mCommunicator).onResultFromBlueToothEnableRequest(resultCode, data);
	}

	public void unusableBlueTooth(final ServiceCommunicator.BLUETOOTH_ERROR_REASON pReason) {
		/* TODO
	...
	public void onDestroy() {
		((ServiceCommunicator) mCommunicator).onDestroy();
	}
}
